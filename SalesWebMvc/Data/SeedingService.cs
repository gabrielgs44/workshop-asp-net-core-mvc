...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 21), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 21), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 21), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 21), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alexpink@gmail.com", new DateTime(1997, 4, 21), 3000.0, d2);
            ...
            _context.SalesRecord.AddRange(
                r2, r2, r3, r4, r5, r6, r7, r8, r9, r10,
